        ...
        <center>
            ...
            <table border="1px solid black">
                <tr>
                    ...
                    <th>Specialty</th>
                    <th>Contact</th>
                    <th>Fees</th> <!-- New Fees Column -->
                    <th>Doctor Timing</th> <!-- New Doctor Timing Column -->
                    <th>AM/PM</th> <!-- New AM/PM Column -->
                    <th>Delete</th>
                </tr>
                <c:forEach items="${list}" var="d">  
                    <tr>
                        ...
                        <td>${d.getContact()}</td> 
                        <td>${d.getFees()}</td> <!-- Display Fees -->
                        <td>${d.getDoctorTime()}</td> <!-- Display Doctor Timing -->
                        <td>${d.getAmPm()}</td> <!-- Display AM/PM -->
