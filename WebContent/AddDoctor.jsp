    ...
    <div class="container">
        <ul>
            <a href="AdminHome.jsp"><li class="roundbox">Doctor's Details</li></a>
                 <a href="AppointmentDetails.jsp"><li class="roundbox">Appoitnment Details</li></a>
        ...
        <form action="DoctorReg" method="post">
            <div class="reg">
                <table>
                    <tr>
                        <td>Doctor Name:</td>
                        <td><input type="text" name="docname" placeholder="Full Name" required></td> <!-- Changed dname to docname -->
                    </tr>
                    <tr>
                        <td>Email Id:</td>
                        <td><input type="email" name="email" placeholder="xyz@gmail.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" required></td>
                    </tr>
                    <tr>
                        <td>Password :</td>
                    ...
                    <tr>
                        <td>Contact No:</td>
                        <td><input type="text" name="contact" placeholder="xxxxxxxxx" pattern="^\d{10}$" required></td>
                    </tr>
                    <tr>
                        <td>Fees (in Rs):</td>
                        <td><input type="number" name="fees" placeholder="Enter Fees" required></td>
                    </tr>
                    <tr>
                        <td>Timing:</td>
                        <td>
                            <input type="text" name="doctorTime" placeholder="09:00" required>
